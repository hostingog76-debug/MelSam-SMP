...
<body>
    ...
    <div class="container">
        <header>
            ...
            <div class="owner-info">
                <div class="owner-card">
                    <div class="owner-name">👑 Owner: the_sam_og</div>
                </div>
                <div class="owner-card">
        ...
        <footer>
            ...
            <p>Join <strong>melsamsmp.net</strong> and start your lifesteal adventure!</p>
            <p>&copy; 2026 MelSamsMP. Made with ❤️ by the_sam_og & melxi</p>
        </footer>
    </div>
    ...
    <script>
        ...
        document.querySelector('.ip-text').addEventListener('click', function() {
            navigator.clipboard.writeText('melsamsmp.net');
